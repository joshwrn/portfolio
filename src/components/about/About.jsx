    ...
    <motion.div ref={ref} animate={animateText} className={Styles.container}>
      ...
      <div className={Styles.sectionContainer}>
        <p className={Styles.summary}>
          ...
          part of an actual team. I've spent most of my time during the pandemic studying coding and
          teaching myself different programming languages. When I'm not coding I like to mess around
          in Photoshop and occasionally I make beats for youtube, where I have over 10,000
          subscribers.
        </p>
